...
#include <windows.h>
#include <pthread.h>
pthread_mutex_t lock_1, lock_2, lock_3, lock_4, lock_5, lock_6, lock_7, lock_8, lock_9;
...
void *as_4(void *time_4)
{
    while(1)
    {
    pthread_mutex_lock(&lock_5);
    asteroids_4();
    pthread_mutex_unlock(&lock_5);
    }
}
void *as_5(void *time_5)
{
    while(1)
    {
    pthread_mutex_lock(&lock_6);
    asteroids_5();
    pthread_mutex_unlock(&lock_6);
    }
}
void *as_6(void *time_6)
{
    while(1)
    {
    pthread_mutex_lock(&lock_7);
    asteroids_6();
    pthread_mutex_unlock(&lock_7);
    }
}
void *as_7(void *time_7)
{
    while(1)
    {
    pthread_mutex_lock(&lock_8);
    asteroids_7();
    pthread_mutex_unlock(&lock_8);
    }
}
void *as_8(void *time_8)
{
    while(1)
    {
    pthread_mutex_lock(&lock_9);
    asteroids_8();
    pthread_mutex_unlock(&lock_9);
    }
}
int main()
{   
    ...
    pthread_mutex_init(&lock_5, NULL);
    pthread_mutex_init(&lock_6, NULL);
    pthread_mutex_init(&lock_7, NULL);
    pthread_mutex_init(&lock_8, NULL);
    pthread_mutex_init(&lock_9, NULL);
    ...
    pthread_mutex_destroy(&lock_4);
    pthread_mutex_destroy(&lock_5);
    pthread_mutex_destroy(&lock_6);
    pthread_mutex_destroy(&lock_7);
    pthread_mutex_destroy(&lock_8);
    pthread_mutex_destroy(&lock_9);
}
